...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Registration.notified_date'
        db.add_column('pyconfi2012_registration', 'notified_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registration.notified_date'
        db.delete_column('pyconfi2012_registration', 'notified_date')
