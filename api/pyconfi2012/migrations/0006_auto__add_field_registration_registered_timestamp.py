...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pyconfi2012_registration', 'registered_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 17, 22, 0), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registration.registered_timestamp'
        db.delete_column('pyconfi2012_registration', 'registered_timestamp')
