...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pyconfi2012_registration', 'extra', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Changing field 'Registration.billing_address'
        db.alter_column('pyconfi2012_registration', 'billing_address', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Registration.billing_zipcode'
        db.alter_column('pyconfi2012_registration', 'billing_zipcode', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Registration.billing_city'
        db.alter_column('pyconfi2012_registration', 'billing_city', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Registration.extra'
        db.delete_column('pyconfi2012_registration', 'extra')
