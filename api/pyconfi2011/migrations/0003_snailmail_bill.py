...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pyconfi2011_registration', 'snailmail_bill', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registration.snailmail_bill'
        db.delete_column('pyconfi2011_registration', 'snailmail_bill')
