...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pyconfi2011_registration', 'notified_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Registration.notified_date'
        db.delete_column('pyconfi2011_registration', 'notified_date')
