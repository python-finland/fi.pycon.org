...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('pyconfi2011_registration', 'billing_city', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Registration.country'
        db.add_column('pyconfi2011_registration', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=2), keep_default=False)

        # Adding field 'Registration.billed'
        db.add_column('pyconfi2011_registration', 'billed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Registration.paid'
        db.add_column('pyconfi2011_registration', 'paid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Registration.ticket_type'
        db.alter_column('pyconfi2011_registration', 'ticket_type', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Deleting field 'Registration.dinner'
        db.delete_column('pyconfi2011_registration', 'dinner')

        # Deleting field 'Registration.billing_address'
        db.delete_column('pyconfi2011_registration', 'billing_address')

        # Deleting field 'Registration.billing_zipcode'
        db.delete_column('pyconfi2011_registration', 'billing_zipcode')

        # Deleting field 'Registration.billing_city'
        db.delete_column('pyconfi2011_registration', 'billing_city')

        # Deleting field 'Registration.country'
        db.delete_column('pyconfi2011_registration', 'country')

        # Deleting field 'Registration.billed'
        db.delete_column('pyconfi2011_registration', 'billed')

        # Deleting field 'Registration.paid'
        db.delete_column('pyconfi2011_registration', 'paid')
